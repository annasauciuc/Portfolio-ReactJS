export const englishTranslations = {
    ...
    "SECTION_ABOUT_ME_TEXT": "I'm a self-taught Web Developer! Starting this wonderful journey, with big aspiration, with endless dreams and a lot a hope. My journey started in the   <a href'https://20h.es/' target='_blank' class='hoverLine'> <strong><u>20h Talent Bootcamp</u>, </strong></a>where i had the oportunity to meet a lot of talented people and adquire knowledge from them. I'm a dreamer with my feet on the ground, a nature lover, world lover. I think what best defines me is the passion that i put in all that i do, no matter that is a project or just a simple matter of my cotidian life.Positive, negative, sad, happy.I have them all. Just so greatfull for the oportunity of life that was gaved to me. I never take things for granted. <br><br>Do you want to see some of my starting<a href='../../html/projects.html'><strong><u> projects</strong></u>?",
    ...
    "CODEQUOTE": "  <blockquote class='ml-3 mr-3 text-center quote' id='codeQuote'><em><h2>Programming isn’t something you do from 9 to 17. It’s not a job, it’s a way of life.</h2> <em> </blockquote>",
